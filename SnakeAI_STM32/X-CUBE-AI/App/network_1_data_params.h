...
#define AI_NETWORK_1_DATA_ACTIVATIONS_SIZES \
  { 1068, }
#define AI_NETWORK_1_DATA_ACTIVATIONS_SIZE     (1068)
#define AI_NETWORK_1_DATA_ACTIVATIONS_COUNT    (1)
#define AI_NETWORK_1_DATA_ACTIVATION_1_SIZE    (1068)



#define AI_NETWORK_1_DATA_WEIGHTS_SIZES \
  { 15372, }
#define AI_NETWORK_1_DATA_WEIGHTS_SIZE         (15372)
#define AI_NETWORK_1_DATA_WEIGHTS_COUNT        (1)
#define AI_NETWORK_1_DATA_WEIGHT_1_SIZE        (15372)
