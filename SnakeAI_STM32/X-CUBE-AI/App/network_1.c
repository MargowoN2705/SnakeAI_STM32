...
#define AI_NETWORK_1_MODEL_SIGNATURE     "0x1b3cebf23d9338b0f4e8b556be1d00d1"
...
#define AI_TOOLS_DATE_TIME   "2025-06-14T21:53:26+0200"
...
AI_NETWORK_OBJ_DECLARE(
  ...
  &_linear_1_Gemm_output_0_layer, 0xc09dd46b, NULL)
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_1_activations_map, 1, params)) {
    ...
    input_output_array.data = AI_PTR(g_network_1_activations_map[0] + 0);
    input_output_array.data_start = AI_PTR(g_network_1_activations_map[0] + 0);
    _linear_1_Gemm_output_0_output_array.data = AI_PTR(g_network_1_activations_map[0] + 44);
    _linear_1_Gemm_output_0_output_array.data_start = AI_PTR(g_network_1_activations_map[0] + 44);
    _relu_Relu_output_0_output_array.data = AI_PTR(g_network_1_activations_map[0] + 44);
    _relu_Relu_output_0_output_array.data_start = AI_PTR(g_network_1_activations_map[0] + 44);
    output_output_array.data = AI_PTR(g_network_1_activations_map[0] + 0);
    output_output_array.data_start = AI_PTR(g_network_1_activations_map[0] + 0);
    return true;
  }
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_1_weights_map, 1, params)) {
    ...
    _linear_1_Gemm_output_0_weights_array.data = AI_PTR(g_network_1_weights_map[0] + 0);
    _linear_1_Gemm_output_0_weights_array.data_start = AI_PTR(g_network_1_weights_map[0] + 0);
    _linear_1_Gemm_output_0_bias_array.format |= AI_FMT_FLAG_CONST;
    _linear_1_Gemm_output_0_bias_array.data = AI_PTR(g_network_1_weights_map[0] + 11264);
    _linear_1_Gemm_output_0_bias_array.data_start = AI_PTR(g_network_1_weights_map[0] + 11264);
    output_weights_array.format |= AI_FMT_FLAG_CONST;
    output_weights_array.data = AI_PTR(g_network_1_weights_map[0] + 12288);
    output_weights_array.data_start = AI_PTR(g_network_1_weights_map[0] + 12288);
    output_bias_array.format |= AI_FMT_FLAG_CONST;
    output_bias_array.data = AI_PTR(g_network_1_weights_map[0] + 15360);
    output_bias_array.data_start = AI_PTR(g_network_1_weights_map[0] + 15360);
    return true;
  }
