...
#include "myai_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_MYAI_MODEL_NAME          "myai"
#define AI_MYAI_ORIGIN_MODEL_NAME   "model_best"

/******************************************************************************/
#define AI_MYAI_ACTIVATIONS_ALIGNMENT   (4)
#define AI_MYAI_INPUTS_IN_ACTIVATIONS   (4)
#define AI_MYAI_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_MYAI_IN_NUM        (1)

AI_DEPRECATED
#define AI_MYAI_IN \
  ai_myai_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_MYAI_IN_SIZE { \
  AI_MYAI_IN_1_SIZE, \
}
#define AI_MYAI_IN_SIZE_BYTES { \
  AI_MYAI_IN_1_SIZE_BYTES, \
}
#define AI_MYAI_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_MYAI_IN_1_CHANNEL     (11)
#define AI_MYAI_IN_1_SIZE        (11)
#define AI_MYAI_IN_1_SIZE_BYTES  (44)

/******************************************************************************/
#define AI_MYAI_OUT_NUM       (1)

AI_DEPRECATED
#define AI_MYAI_OUT \
  ai_myai_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_MYAI_OUT_SIZE { \
  AI_MYAI_OUT_1_SIZE, \
}
#define AI_MYAI_OUT_SIZE_BYTES { \
  AI_MYAI_OUT_1_SIZE_BYTES, \
}
#define AI_MYAI_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_MYAI_OUT_1_CHANNEL     (3)
#define AI_MYAI_OUT_1_SIZE        (3)
#define AI_MYAI_OUT_1_SIZE_BYTES  (12)

/******************************************************************************/
#define AI_MYAI_N_NODES (3)
 ...
 * @ref ai_myai_create. Both the activations memory buffer 
 ...
 * header generated by the code generation tool. See AI_MYAI_*
 * defines into file @ref myai.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
